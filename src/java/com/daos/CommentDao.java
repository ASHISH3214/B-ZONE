...
public class CommentDao {
   ...
   public boolean add(Comment comment){
        ...
        smt.close();
            ...
            System.out.println("Error in wrting comment....." + e.getMessage());
        }
   ...
   public boolean addReply(int id,String text){
    ...
    public ArrayList<Comment> getAllCommentByBlogId(int blogId) {
   ...
   public ArrayList<Comment> getAllCommentByBloggerId(int bloggerId) {
        ArrayList<Comment> commentList = new ArrayList();
