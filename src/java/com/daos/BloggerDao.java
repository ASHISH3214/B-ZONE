...
public class BloggerDao {
    public boolean add(Blogger blogger,String catIds[]){
        ...
        try {
            ...
            if(smt.executeUpdate()>0){
                ...
                //fetch the recent blogger's id who has registered above
        ...
        //insert the relation of blogger and category inside bloggercategory table       
            ...
            try {  con.rollback(); } catch (Exception ex) {System.out.println("Error in rollback :" + e.getMessage()); }
    ...
    public Blogger getByLoginDetails(String userid,String password){
        ...
        try {
            ...
            System.out.println("Error in fetching loginDetail :" + e.getMessage());
        }
        return blogger;
    }
    ...
    public boolean changeStatus(int id,String statusValue){
        ...
        try {
            ...
            System.out.println("Error in change status :" + e.getMessage());
        }
    ...
    public boolean isUseridExist(String userid){
        ...
        try {
            ...
            System.out.println("UserId check failed...." + e.getMessage());
        }
        return status;
    }
