<%-- 
    ...
    Created on : 10 Jun, 2021, 9:52:07 PM
    Author     : HP
--%>
    ...
    <div class="templatemo-flex-row">
      ...
      <jsp:include page="header.jsp"></jsp:include>
        <div class="templatemo-content-container">
            ...
            <center><h2>Details of Blogger</h2></center><hr/>
            <%
       ...
       <p class="form-group"><b>Change Status</b> :<br/>
           <select name="status" class="dropdown">
               ...
               <option value="rejected" <%=blogger.getStatus().equals("rejected")?"selected":""%>>Rejected</option>
         
           </select>
       </p> 
       <a href="showBloggers.jsp" class="btn btn-success"> Back</a><br/>
