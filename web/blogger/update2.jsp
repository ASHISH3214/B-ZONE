<%-- 
    Document   : update2
    Created on : 5 Jul, 2021, 8:41:35 PM
    Author     : HP
--%>
  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
      ...
      <jsp:include page="header.jsp"></jsp:include>
        ...
        <jsp:useBean id="blog" scope="session" class="com.beans.Blog" ></jsp:useBean>
       
        <% 
              String categories[] = request.getParameterValues("category");
              session.setAttribute("categories", categories);
              BlogDao bd = new BlogDao();
              blog = bd.getBlogDetailById(Integer.parseInt(request.getParameter("id")));
             ...
             %>
                    ...
                    <center>
                        <form action="../BlogController?op=update" method="post" enctype="multipart/form-data">
                            <img src="../<%=blog.getPoster()%>" id="preview" style="width: 300px; height: 400px; border-radius: 10px;border-style: solid;">
                        <br/><br/>
