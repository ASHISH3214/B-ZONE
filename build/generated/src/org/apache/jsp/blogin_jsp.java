...
public final class blogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("    <title>Stand CSS Blog by TemplateMo</title>\n");
      out.write("\n");
      ...
      out.write("    ");
        ...
        for(Cookie c : cookie){
            if(c.getName().equals("bloggerUserid"))
                userid=c.getValue();
            if(c.getName().equals("bloggerPassword"))
                password=c.getValue();
        }
      ...
      out.write("              <div class=\"row\">\n");
      out.write("                 <!--change the following contents--> \n");
      out.write("                  \n");
      out.write("                <div class=\"col-lg-12\">\n");
      out.write("                    <span style=\"color: red;font-family: corbel;font-size: 20px;\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${param.errorMessage}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("</span>\n");
      out.write("                    <center><h1>Blogger Login</h1></center>\n");
      out.write("                    \n");
      out.write("                    <form action=\"BloggerController?op=login\" method=\"post\"  class=\"form-group\">\n");
      out.write("                        Enter Username <input type=\"email\" name=\"userid\" value=\"");
      out.print(userid);
      out.write("\" required class=\"form-control\"/>\n");
      out.write("                        <br/>\n");
      out.write("                        Enter Password <input type=\"password\" name=\"password\" value=\"");
      out.print(password);
      out.write("\" required class=\"form-control\"/>\n");
      out.write("                        <br/>\n");
      out.write("                        <input type=\"checkbox\" value=\"remember\" name=\"remember\"/>Remember me\n");
      out.write("                        <br/>\n");
      out.write("                        <input type=\"submit\" value=\"Login\" name=\"submit\" class=\"btn btn-primary\"/>\n");
      out.write("                    </form>\n");
      out.write("                \n");
      out.write("                </div>\n");
      out.write("              </div>\n");
