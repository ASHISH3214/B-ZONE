<%-- 
    Document   : update1
    Created on : 5 Jul, 2021, 8:41:27 PM
    Author     : HP
--%>
  ...
  <body>  
    ...
    <div class="templatemo-flex-row">
     ...
     <%
         ...
         ArrayList<Category> clist = cd.getCategoriesByBloggerId(blogger.getId());
         ArrayList<Category> clist2 = cd.getCategoriesByBlogId(id);
         ...
         <input type="checkbox" name="category" value="<%=c.getId()%>" <%for(Category cc: clist2) if(cc.getId()==c.getId()) {out.println("checked"); break;} %>/><%=c.getName()%> <br/>
            ...
            Enter Description <textarea name="description" class="form-control" rows="15" cols="20" >
                <%=blog.getDescription()%>
            </textarea>
            
            
            Date of Posting : <b><%=blog.getDate()%></b>
