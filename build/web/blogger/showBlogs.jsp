...
<%-- 
    Document   : showBlogs
    Created on : 12 Jun, 2021, 5:15:34 PM
    Author     : HP
--%>
      ...
      <jsp:include page="header.jsp"></jsp:include>
        <div class="templatemo-content-container">
            ...
            <table class="table table-hover table-striped table-dark">
                ...
                <%
                    ArrayList<Blog> blist = new BlogDao().getAllBlogsBloggerId(blogger.getId());
                    for(Blog blog : blist){%>
                    <tr>
                    <td><%=blog.getId()%></td>
                    <td><%=blog.getTitle()%></td>
                    <td><img src="../<%=blog.getPoster()%>" style="width: 70px;height: 70px;border-radius: 50px;"/></td>
                    <td class="<%=blog.getStatus().equals("pending")?"text-danger font-weigth-bold":""%>"><b><%=blog.getStatus()%></b></td>
                    <td><a href="update1.jsp?id=<%=blog.getId()%>" class="btn btn-success" style="width: 150px">View and Edit</a> <br/><br/>
                        <a href="#" class="btn btn-primary" style="width: 150px"> Request to Approve </a>
                    </td>
                    </tr>
